...
It took me some time to figure out how to show and update the character count for tweets. I didn't change the first two methods for the text watcher, and I didn't realize they could be left blank.
...
The most problems I've encountered have to do with the alignment of TextViews when editing the display of xml files.
